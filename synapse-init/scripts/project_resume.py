...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Resume a Synapse project from MEMORY_MAP.json.",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""Examples:
  project_resume.py --project .
  project_resume.py --project . --focus payment
  project_resume.py --project . --focus auth --json
""",
    )
