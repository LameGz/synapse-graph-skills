...
v1.5 product shape: this skill remains the lightweight natural-language write entry for the Synapse suite. Low-confidence auto-observed proposals should be reviewed through the core Memory Inbox (`.synapse/inbox.json`) instead of being treated as final memory.
