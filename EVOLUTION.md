...
> 记录从 v1.0 到后续版本的关键架构决策、吸收的外部知识、以及每次迭代的"为什么"。
>
> **版本命名说明**：Synapse 体系经历三代——V1（脚本）、V2（单体 Agent）、V3（Skills 形态）。本仓库是 V3 的落地实现，版本号从 v1.0.0 起算（SemVer）。文档中的"V3.0"对应仓库版本 v1.0，"V3.1"对应 v1.1，以此类推。
...
## V3.4.0 ✅ — 已实现（AI 自主记忆写入）2026-05-24
